...
public class DolphinSchedulerCommandApp extends CommandApp {
    ...
    public void run(String[] args) {
        ...
        options.addOption(OPT_SKIP_RESOURCES, LONG_OPT_SKIP_RESOURCES, false, "skip exporting resources");
        ...
        try {
            ...
            String file = commandLine.getOptionValue("f", "output.zip");
            ...
            exporter.setSkipResources(commandLine.hasOption(OPT_SKIP_RESOURCES));
