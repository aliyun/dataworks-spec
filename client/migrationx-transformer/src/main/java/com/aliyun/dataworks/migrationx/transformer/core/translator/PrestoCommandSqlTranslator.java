 ...
 * @date 2021/02/20
 */
public class PrestoCommandSqlTranslator extends AbstractCommandSqlTranslator {
    ...
    public boolean match(DwWorkflow workflow, DwNode node) {
        return super.match(workflow, node) && StringUtils.contains(node.getCode(), "--execute");
    }
    ...
    protected Options getGnuOptions() {
        ...
        options.addOption(OptionBuilder
            .withLongOpt("execute")
            .hasArg()
            .withArgName("execute statement")
            .withDescription("execute statement")
            .create());
        return options;
    }
}
