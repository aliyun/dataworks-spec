...
package com.aliyun.dataworks.migrationx.transformer.flowspec.converter.dolphinscheduler.mr;
 ...
 * @date 2024-06-26
 */
public class MapReduceParameterConverter extends AbstractParameterConverter<MapReduceParameters> {
    public MapReduceParameterConverter(DataWorksWorkflowSpec spec, SpecWorkflow specWorkflow, TaskDefinition taskDefinition,
