...
package com.aliyun.dataworks.migrationx.transformer.flowspec.converter.dolphinscheduler.sqoop;
...
public class SqoopParameterConverter extends AbstractParameterConverter<SqoopParameters> {
    ...
    public SqoopParameterConverter(DataWorksWorkflowSpec spec, SpecWorkflow specWorkflow, TaskDefinition taskDefinition,
