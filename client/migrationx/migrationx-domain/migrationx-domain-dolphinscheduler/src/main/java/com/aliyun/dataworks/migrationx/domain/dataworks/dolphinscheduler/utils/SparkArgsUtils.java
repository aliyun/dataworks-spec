...
import com.aliyun.dataworks.migrationx.domain.dataworks.dolphinscheduler.v3.model.SparkConstants;
...
public class SparkArgsUtils {
    ...
    public static List<String> buildArgs(SparkParameters param) {
        ...
        if (mainJar != null) {
            args.add(StringUtils.defaultString(mainJar.getRes(), mainJar.getResourceName()));
        }
    ...
    public static List<String> buildArgs(com.aliyun.dataworks.migrationx.domain.dataworks.dolphinscheduler.v3.task.spark.SparkParameters param) {
        ...
        com.aliyun.dataworks.migrationx.domain.dataworks.dolphinscheduler.v3.model.ResourceInfo mainJar = param.getMainJar();
        if (mainJar != null) {
