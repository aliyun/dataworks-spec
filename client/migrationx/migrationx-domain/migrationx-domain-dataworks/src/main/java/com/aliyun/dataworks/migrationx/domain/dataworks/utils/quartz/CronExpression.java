...
public class CronExpression implements Serializable, Cloneable {
    ...
    public static final int DIFFERENCE = 1000;
    ...
    public static final Integer ALL_SPEC = ALL_SPEC_INT;
    public static final Integer NO_SPEC = NO_SPEC_INT;

    public static final Map<String, Integer> MONTH_MAP = new HashMap<String, Integer>(20);
    public static final Map<String, Integer> DAY_MAP = new HashMap<String, Integer>(60);
    ...
    public Date getNextInvalidTimeAfter(Date date) {
        ...
        return new Date(lastDate.getTime() + DIFFERENCE);
    }
    ...
    protected void buildExpression(String expression) throws ParseException {
        ...
        try {
            ...
            while (exprsTok.hasMoreTokens() && exprOn <= YEAR) {
                ...
                if (exprOn == DAY_OF_WEEK && expr.indexOf('#') != -1 && expr.indexOf('#', expr.indexOf('#') + 1)
                    != -1) {
