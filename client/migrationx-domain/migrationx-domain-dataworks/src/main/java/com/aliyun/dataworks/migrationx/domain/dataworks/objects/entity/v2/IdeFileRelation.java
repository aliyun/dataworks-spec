...
@JacksonXmlRootElement(localName = "fileRelation")
@Data
public class IdeFileRelation {
    ...
    @JacksonXmlProperty(isAttribute = true, localName = "parentFileDelete")
    private Integer parentFileDelete;
    @JacksonXmlProperty(isAttribute = true, localName = "refTable")
