...
public class DataWorksNodeInputOutputAdapterTest {
    ...
    @Test
    public void testInputVariableWithInputName() {
        String specJson = "{\n"
            + "\t\"version\":\"1.1.0\",\n"
            + "\t\"kind\":\"CycleWorkflow\",\n"
            + "\t\"spec\":{\n"
            ...
            + "\t\t\t\t\"script\":{\n"
            + "\t\t\t\t\t\"language\":\"odps-sql\",\n"
            + "\t\t\t\t\t\"path\":\"业务流程/体验案例1_用户行为分析/MaxCompute/数据开发/临时分析文件/用户行为分析结果查询/用户行为分析结果查询\",\n"
            + "\t\t\t\t\t\"runtime\":{\n"
            + "\t\t\t\t\t\t\"command\":\"ODPS_SQL\",\n"
            + "\t\t\t\t\t\t\"commandTypeId\":10,\n"
            + "\t\t\t\t\t\t\"cu\":\"0.25\"\n"
            ...
            + "\t\t\t\t},\n"
            + "\t\t\t\t\"runtimeResource\":{\n"
            + "\t\t\t\t\t\"resourceGroup\":\"S_res_group_524257424564736_1735204013522\"\n"
            + "\t\t\t\t},\n"
            + "\t\t\t\t\"name\":\"用户行为分析结果查询\",\n"
            + "\t\t\t\t\"owner\":\"1107550004253538\",\n"
            + "\t\t\t\t\"inputs\":{\n"
            ...
            + "\t\t\t\t\t\"nodeOutputs\":[\n"
            + "\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\"data\":\"sx_test.503367247_out_original\",\n"
            + "\t\t\t\t\t\t\t\"artifactType\":\"NodeOutput\",\n"
            + "\t\t\t\t\t\t\t\"isDefault\":false\n"
            + "\t\t\t\t\t\t}\n"
            + "\t\t\t\t\t]\n"
            ...
            + "\t\t\t\t\t\"nodeOutputs\":[\n"
            + "\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\"data\":\"sx_test.503410287_out_original\",\n"
            + "\t\t\t\t\t\t\t\"artifactType\":\"NodeOutput\",\n"
            + "\t\t\t\t\t\t\t\"isDefault\":false\n"
            + "\t\t\t\t\t\t},\n"
            + "\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\"data\":\"sx_test.504820348_out\",\n"
            + "\t\t\t\t\t\t\t\"artifactType\":\"NodeOutput\",\n"
            + "\t\t\t\t\t\t\t\"isDefault\":true\n"
            + "\t\t\t\t\t\t},\n"
            + "\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\"data\":\"sx_test.用户行为分析结果查询\",\n"
            + "\t\t\t\t\t\t\t\"artifactType\":\"NodeOutput\",\n"
            + "\t\t\t\t\t\t\t\"isDefault\":false\n"
            + "\t\t\t\t\t\t}\n"
            + "\t\t\t\t\t]\n"
            ...
            + "\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\"type\":\"Normal\",\n"
            + "\t\t\t\t\t\t\"output\":\"sx_test.503367247_out_original\"\n"
            + "\t\t\t\t\t}\n"
            + "\t\t\t\t]\n"
            + "\t\t\t}\n"
            + "\t\t]\n"
            ...
            + "\t}\n"
            + "}";
        log.info("spec: {}", specJson);
        Specification<DataWorksWorkflowSpec> spec = SpecUtil.parseToDomain(specJson);
        DataWorksNodeAdapter adapter = new DataWorksNodeAdapter(spec, spec.getSpec().getNodes().get(0));
        log.info("inputs: {}", adapter.getInputContexts());
        Assert.assertEquals(1, CollectionUtils.size(adapter.getInputContexts()));
        Assert.assertEquals("12312312:outputs", adapter.getInputContexts().get(0).getRefKey());
        Assert.assertEquals("input1", adapter.getInputContexts().get(0).getKey());
    }

    @Test
    public void testInputVariableWithInputNameMultipleKeyWithSameVariable() {
        String specJson = "{\n"
            + "\t\"version\":\"1.1.0\",\n"
            + "\t\"kind\":\"CycleWorkflow\",\n"
            + "\t\"spec\":{\n"
            ...
            + "\t\t\t\t\"script\":{\n"
            + "\t\t\t\t\t\"language\":\"odps\",\n"
            + "\t\t\t\t\t\"path\":\"/createNode/odps_sql_1763689608\",\n"
            + "\t\t\t\t\t\"runtime\":{\n"
            + "\t\t\t\t\t\t\"engine\":\"MaxCompute\",\n"
            + "\t\t\t\t\t\t\"command\":\"ODPS_SQL\",\n"
            + "\t\t\t\t\t\t\"commandTypeId\":10,\n"
            ...
            + "\t\t\t\t\t\t\t\t\"value\":\"${outputs}\",\n"
            + "\t\t\t\t\t\t\t\t\"node\":{\n"
            + "\t\t\t\t\t\t\t\t\t\"nodeId\":\"5310891437520223010\",\n"
            + "\t\t\t\t\t\t\t\t\t\"output\":\"mock_local_project.odps_sql_1763646585\"\n"
            + "\t\t\t\t\t\t\t\t}\n"
            + "\t\t\t\t\t\t\t}\n"
            + "\t\t\t\t\t\t},\n"
            + "\t\t\t\t\t\t{\n"
            ...
            + "\t\t\t\t},\n"
            + "\t\t\t\t\"runtimeResource\":{\n"
            + "\t\t\t\t\t\"resourceGroup\":\"S_res_group_524257424564736_1741854946207\",\n"
            + "\t\t\t\t\t\"resourceGroupId\":\"1\"\n"
            + "\t\t\t\t},\n"
            + "\t\t\t\t\"name\":\"odps_sql_1763689608\",\n"
            + "\t\t\t\t\"owner\":\"WORKER_1482465063962\",\n"
            + "\t\t\t\t\"description\":\"odps_sql_1763689608\",\n"
            + "\t\t\t\t\"metadata\":{\n"
            + "\t\t\t\t\t\"createTime\":\"2025-11-21 09:46:48\",\n"
            + "\t\t\t\t\t\"owner\":\"WORKER_1482465063962\",\n"
            + "\t\t\t\t\t\"ownerName\":\"showName-WORKER_1482465063962\",\n"
            + "\t\t\t\t\t\"project\":{\n"
            + "\t\t\t\t\t\t\"projectIdentifier\":\"mock_local_project\",\n"
            + "\t\t\t\t\t\t\"projectName\":\"mock_local_project\",\n"
            + "\t\t\t\t\t\t\"projectId\":\"23620\"\n"
            + "\t\t\t\t\t},\n"
            + "\t\t\t\t\t\"projectId\":\"23620\",\n"
            + "\t\t\t\t\t\"tenantId\":\"1\"\n"
            ...
            + "\t\t\t\t\t\"nodeOutputs\":[\n"
            + "\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\"data\":\"8718350199738536641\",\n"
            + "\t\t\t\t\t\t\t\"artifactType\":\"NodeOutput\",\n"
            + "\t\t\t\t\t\t\t\"sourceType\":\"System\",\n"
            + "\t\t\t\t\t\t\t\"refTableName\":\"odps_sql_1763689608\",\n"
            + "\t\t\t\t\t\t\t\"isDefault\":true\n"
            + "\t\t\t\t\t\t},\n"
            + "\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\"data\":\"autotest.test_code_parse_output\",\n"
            + "\t\t\t\t\t\t\t\"artifactType\":\"NodeOutput\",\n"
            + "\t\t\t\t\t\t\t\"sourceType\":\"CodeParse\"\n"
            + "\t\t\t\t\t\t},\n"
            + "\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\"data\":\"mock_local_project.odps_sql_1763689608\",\n"
            + "\t\t\t\t\t\t\t\"artifactType\":\"NodeOutput\",\n"
            + "\t\t\t\t\t\t\t\"sourceType\":\"System\",\n"
            + "\t\t\t\t\t\t\t\"refTableName\":\"odps_sql_1763689608\",\n"
            + "\t\t\t\t\t\t\t\"isDefault\":false\n"
            ...
            + "\t\t\"flow\":[\n"
            + "\t\t\t{\n"
            + "\t\t\t\t\"nodeId\":\"8718350199738536641\",\n"
            + "\t\t\t\t\"depends\":[\n"
            + "\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\"type\":\"Normal\",\n"
            + "\t\t\t\t\t\t\"output\":\"mock_local_project_root\",\n"
            + "\t\t\t\t\t\t\"sourceType\":\"Manual\"\n"
            + "\t\t\t\t\t},\n"
            + "\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\"type\":\"Normal\",\n"
            + "\t\t\t\t\t\t\"output\":\"mock_local_project.odps_sql_1763646585\",\n"
            + "\t\t\t\t\t\t\"sourceType\":\"Manual\",\n"
            + "\t\t\t\t\t\t\"refTableName\":\"odps_sql_1763646585\"\n"
            + "\t\t\t\t\t},\n"
            + "\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\"type\":\"Normal\",\n"
            + "\t\t\t\t\t\t\"output\":\"5310891437520223010\",\n"
            + "\t\t\t\t\t\t\"sourceType\":\"Manual\",\n"
            + "\t\t\t\t\t\t\"refTableName\":\"odps_sql_1763646585\"\n"
            + "\t\t\t\t\t}\n"
            + "\t\t\t\t]\n"
        ...
        DataWorksNodeAdapter adapter = new DataWorksNodeAdapter(spec, spec.getSpec().getNodes().get(0));
        log.info("inputs: {}", adapter.getInputContexts());
        Assert.assertEquals(3, CollectionUtils.size(adapter.getInputContexts()));
        Assert.assertEquals("mock_local_project.odps_sql_1763646585:var1", adapter.getInputContexts().get(0).getRefKey());
        Assert.assertEquals("para1", adapter.getInputContexts().get(0).getKey());
        Assert.assertEquals("mock_local_project.odps_sql_1763646585:var2", adapter.getInputContexts().get(1).getRefKey());
        Assert.assertEquals("para2", adapter.getInputContexts().get(1).getKey());
        Assert.assertEquals("mock_local_project.odps_sql_1763646585:var3", adapter.getInputContexts().get(2).getRefKey());
        Assert.assertEquals("para3", adapter.getInputContexts().get(2).getKey());
    }
}
