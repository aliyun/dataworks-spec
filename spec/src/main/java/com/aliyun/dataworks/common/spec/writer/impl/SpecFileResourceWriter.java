...
/**
 * SpecFileResourceWriter
 *
 * @author 聿剑
 * @date 2023/11/30
 * @see SpecFileResource
 */
@SpecWriter
public class SpecFileResourceWriter extends DefaultJsonObjectWriter<SpecFileResource> {
    public SpecFileResourceWriter(SpecWriterContext context) {
        super(context);
    }
