 ...
 */
@SpecParser
public class EmrJobConfigParser extends DefaultSpecParser<EmrJobConfig> {
    @Override
    public EmrJobConfig parse(Map<String, Object> rawContext, SpecParserContext specParserContext) {
