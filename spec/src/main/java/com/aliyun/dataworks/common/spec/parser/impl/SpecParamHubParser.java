 ...
 */
@SpecParser
public class SpecParamHubParser implements Parser<SpecParamHub> {
    ...
    public SpecParamHub parse(Map<String, Object> rawContext, SpecParserContext specParserContext) {
        ...
        List<Object> variables = Optional.ofNullable((List<Object>)rawContext.get(KEY_VARIABLES)).orElse(new ArrayList<>());
