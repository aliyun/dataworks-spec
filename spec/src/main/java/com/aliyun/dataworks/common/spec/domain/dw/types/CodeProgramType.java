...
public enum CodeProgramType {
    ...
    WORKFLOW(1001, "WORKFLOW", CalcEngineType.GENERAL, null, null),
    COMBINED_NODE(98, "COMBINED_NODE", CalcEngineType.GENERAL, null, ".json"),
    ...
    PAI_FLOW(1250, "PAI_FLOW", CalcEngineType.ALGORITHM, null, ".yaml"),
    ...
    HOLOGRES_SYNC_DATA_TO_MC(1070, "HOLOGRES_SYNC_DATA_TO_MC", CalcEngineType.HOLO, LabelType.DATA_PROCESS, ".hologres.data.sync.json"),
