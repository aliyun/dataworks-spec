 ...
 */
@SpecParser
public class DataWorksNodeSpecParser extends com.aliyun.dataworks.common.spec.parser.impl.SpecParser<DataWorksNodeSpec> {
    @Override
    public boolean support(String kind) {
        return matchKinds(new DataWorksNodeSpec().getKinds(), kind);
    }

    @Override
    public DataWorksNodeSpec parse(Map<String, Object> rawContext, SpecParserContext specParserContext) {
        DataWorksNodeSpec specObj = new DataWorksNodeSpec();
