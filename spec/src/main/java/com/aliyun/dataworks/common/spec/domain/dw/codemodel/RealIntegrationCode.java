...
public class RealIntegrationCode extends AbstractBaseCode implements JsonFormCode {
    private transient JsonObject jsonObject;

    @Override
    public RealIntegrationCode parse(String code) {
    ...
    public List<String> getProgramTypes() {
        return Collections.singletonList(CodeProgramType.RI.name());
    }
